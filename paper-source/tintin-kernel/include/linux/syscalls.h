...
asmlinkage long sys_tintin_event_open(
		struct perf_event_attr __user *attr_uptr,
		pid_t pid, int cpu, int group_fd, unsigned long flags);
asmlinkage long sys_tintin_event_open_with_weight(
		struct perf_event_attr __user *attr_uptr,
		pid_t pid, int cpu, int group_fd, unsigned long flags, unsigned int weight);	
asmlinkage long sys_tintin_create_context(pid_t pid);
asmlinkage long sys_tintin_associate_context(unsigned context_id1, unsigned context_id2);
asmlinkage long sys_tintin_add_event(unsigned context_id, unsigned event_fd));
