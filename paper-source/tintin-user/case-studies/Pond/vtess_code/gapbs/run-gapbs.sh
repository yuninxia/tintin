...
#-------------------------------------------------------------------------------
VTUNE="/opt/intel/oneapi/vtune/2023.2.0/bin64/vtune"
EMON="/opt/intel/oneapi/vtune/2023.2.0/bin64/emon" # Emon path
RUNDIR="/home/cspl/pond/vtess_code"
VMTOUCH="/usr/bin/vmtouch"
DAMON="/users/cspl/git/damo/damo" # user-space tool
TOPLEVDIR=/users/cspl/git/pmu-tools
...
export GAPBS_DIR="/home/cspl/gapbs"
export GAPBS_GRAPH_DIR="/home/cspl/gapbs/benchmark/graphs"
...
run_one_workload_cxl()
{
    ...
    # workload
    GRAPH_DATASET=$(tail -n 1 cmd.sh | awk '{print $5}' | awk -F'/' '{print $2}')
